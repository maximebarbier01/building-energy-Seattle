...
rf_model = RandomForestRegressor(
    n_estimators=600,  # plus d’arbres = variance plus faible
    max_depth=12,  # limite la complexité
    max_features=0.5,  # sous-échantillonnage des variables
    min_samples_split=10,  # plus d'observations pour créer un split
    min_samples_leaf=5,  # feuilles plus grandes
